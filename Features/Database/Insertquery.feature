...
Given  I execute SQL "INSERT INTO `example`.`employee` (Empid, Employeename) VALUES ('11', 'Neha');"
...
And I execute SQL "INSERT INTO `example`.`employee` (Empid, Employeename) VALUES ('1007', ' " $Emp_name "');"
